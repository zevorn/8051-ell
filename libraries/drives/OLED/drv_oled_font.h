/*----------------------------------------------------------------------
  - File name      : drv_oled_font.h
  - Author         : Quark Team
  - Update date    : 2020-12-20                   
  -	Copyright      : Gevico Electronic studio   
  - Module comments: Header file of font module.
-----------------------------------------------------------------------*/
#ifndef __drv_oled_font_H_
#define __drv_oled_font_H_
/*
 * Update note:
 * ------------   ---------------   ------------------------------------
 *     Date            Author                         Note
 * ------------   ---------------   ------------------------------------
 *  2020.12.20         zeweni       Wrote OLED font.
 * 
 */
...
#define    SIZE_16   1  /* Column and row mode */

/*-----------------------------------------------------------------------
|                                 DATA                                  |
-----------------------------------------------------------------------*/

#if (SIZE_16 == 1)  /* Song ti */
code const uint8_t ASCII_16_08[][16]=
{
...
{0x00,0x48,0x70,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*"'",64*/
